...
public class SettingsParser {
        ...
        public Query parse(QueryParseContext parseContext, QueryParserSettings qpSettings) throws IOException, QueryParsingException {
                    ...
                    if ("fields".equals(currentFieldName)) {
                        while ((token = parser.nextToken()) != XContentParser.Token.END_ARRAY) {
                            ...
                            if (qpSettings.fields() == null) {
                                qpSettings.fields(new ArrayList<>());
                            }
                                ...
                                for (String field : parseContext.mapperService().simpleMatchToIndexNames(fField)) {
                                    ...
                                    if (fBoost != -1) {
                                        if (qpSettings.boosts() == null) {
                                            qpSettings.boosts(new ObjectFloatHashMap<>());
                                        }
